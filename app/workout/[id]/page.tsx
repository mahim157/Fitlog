    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="flex flex-col space-y-6">
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {muscleGroups.map((group, idx) => (
                <span
                  key={idx}
                  className="bg-[#CCFF00] text-black text-xs font-extrabold uppercase px-3 py-1 rounded-full tracking-wider"
                >
                  {group}
                </span>
              ))}
          ...
          {/* Key-Value Table */}
          <div className="bg-[#121418] border border-zinc-800/80 rounded-2xl p-5 space-y-3.5 text-xs sm:text-sm">
          ...
          {instructions.length > 0 && (
            <div className="space-y-3 pt-2">
              ...
              <ol className="space-y-2.5 text-zinc-400 text-xs sm:text-sm list-decimal list-inside leading-relaxed">
